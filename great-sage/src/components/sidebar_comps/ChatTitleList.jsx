...
const ChatTitleList = () => {
    const [chatTitleList, setChatTitleList] = React.useState([
    ...
    const updateChatTitle = (chatId, chatTitle) => {
        setChatTitleList(prevList => prevList.map((chat) => {
            if (chat.chatId === chatId) {
                return { ...chat, chatTitle: chatTitle };
            }
            return chat;
        }));
    }
